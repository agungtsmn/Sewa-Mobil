...
@section('content')
  ...
  <div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-2 d-flex align-items-center justify-content-between flex-wrap">
      <div>
        <h4 class="tx-gray-800 mg-b-5">Pendaftaran Pengguna Baru</h4>
        <p class="mg-b-0">Silahkan lengkapi form dibawan untuk melakukan pendaftaran</p>
      </div>
    </div>
    ...
    <div class="br-pagebody">
      <div class="br-section-wrapper">
        ...
        <div class="row">
          <div class="col-xl-6">
            <form action="/register" method="POST" class="form-layout form-layout-4">
              @csrf
              <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Pendaftaran</h6>
              <p class="mg-b-30 tx-gray-600">Isi sesuai dengan data diri anda</p>
              <div class="row">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea rows="2" class="form-control" name="address" placeholder="Masukkan alamat"></textarea>
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">No Hp: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="number" min="0" class="form-control" name="phone_number" placeholder="Masukkan no hp" required>
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">No SIM: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="number" min="0" class="form-control" name="sim_number" placeholder="Masukkan no sim" required>
                </div>
              </div>
              <div class="row mg-t-20">
